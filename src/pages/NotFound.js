// Resourses
// UI: https://app.tailwinduikit.com/listing/marketing/page_section/404_error_pages#errorpage_ii
...
// Media
import error404ld from '../../src/assets/img/error/error404ld.png';
import error404hd from '../../src/assets/img/error/error404hd.png';
    ...
    <Fragment>
      <div className="flex flex-col items-center justify-center py-24 lg:py-12 md:px-16 px-4">
        ...
        <div className="hidden md:grid place-content-center lg:w-1/3 w-1/2">
          <img src={error404hd} alt="girl in an underconstruction site" />
        </div>

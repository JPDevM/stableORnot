...
const LogIn = () => {
  ...
  const [shownOrHide, setShownOrHide] = useState(false);
  const history = useHistory();

//function to show or hide password
  const togglePasswordVisiblity = () => {
    setShownOrHide(shownOrHide ? false : true);
  };
...
//async function for login
  async function handleSubmit(e) {
    ...
    try {
      ...
      setError('Error de credenciales o de conección');
    } /*finally {
      setLoading(false);
    }*/
    setLoading(false);
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-16">
            ...
            <p className="text-sm mt-4 font-medium leading-none text-gray-500">
              ...
              >
                <Link to="/forgot-password">Recuperala!</Link>
              </span>
            </p>
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="mt-6  w-full">
                ...
                <div className="relative flex items-center justify-center">
                  <input
                    type={shownOrHide ? "text" : "password"}
                    ref={passwordRef}
                    required
                    className="bg-gray-200 border rounded focus:outline-none focus:border-black focus:border-4 text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2"
                  />
